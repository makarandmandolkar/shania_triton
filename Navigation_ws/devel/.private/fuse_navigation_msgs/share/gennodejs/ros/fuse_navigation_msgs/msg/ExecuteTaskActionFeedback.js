...
let ExecuteTaskFeedback = require('./ExecuteTaskFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ExecuteTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteTaskActionFeedback(null);
    ...
    data.feedback = ExecuteTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExecuteTaskFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExecuteTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExecuteTaskFeedback()
    }
...
module.exports = ExecuteTaskActionFeedback;
