...
"""autogenerated by genpy from camera_utils/LatestImageRequest.msg. Do not edit."""
import codecs
import sys
...
class LatestImageRequest(genpy.Message):
  _md5sum = "ee5971164a8203b5270f2074d44893e1"
  _type = "camera_utils/LatestImageRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string realsense_source
int32 timeout_millis
"""
  __slots__ = ['realsense_source','timeout_millis']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       realsense_source,timeout_millis
    ...
    """
    if args or kwds:
      super(LatestImageRequest, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.realsense_source is None:
        self.realsense_source = ''
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.realsense_source
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.timeout_millis
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.realsense_source = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.realsense_source = str[start:end]
      start = end
      end += 4
      (self.timeout_millis,) = _get_struct_i().unpack(str[start:end])
      return self
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from camera_utils/LatestImageResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class LatestImageResponse(genpy.Message):
  _md5sum = "196d620881b067ce55d1f9c0a10950a5"
  _type = "camera_utils/LatestImageResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
bool do_rectify
"""
  __slots__ = ['success','color_image','depth_image','depth_camera_info']
  _slot_types = ['bool','sensor_msgs/Image','sensor_msgs/Image','sensor_msgs/CameraInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       success,color_image,depth_image,depth_camera_info
    ...
    """
    if args or kwds:
      super(LatestImageResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.success, _x.color_image.header.seq, _x.color_image.header.stamp.secs, _x.color_image.header.stamp.nsecs))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.depth_camera_info.header.seq, _x.depth_camera_info.header.stamp.secs, _x.depth_camera_info.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_get_struct_6IB().pack(_x.depth_camera_info.binning_x, _x.depth_camera_info.binning_y, _x.depth_camera_info.roi.x_offset, _x.depth_camera_info.roi.y_offset, _x.depth_camera_info.roi.height, _x.depth_camera_info.roi.width, _x.depth_camera_info.roi.do_rectify))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.color_image.header.seq, _x.color_image.header.stamp.secs, _x.color_image.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      ...
      (_x.depth_camera_info.header.seq, _x.depth_camera_info.header.stamp.secs, _x.depth_camera_info.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.depth_camera_info.binning_x, _x.depth_camera_info.binning_y, _x.depth_camera_info.roi.x_offset, _x.depth_camera_info.roi.y_offset, _x.depth_camera_info.roi.height, _x.depth_camera_info.roi.width, _x.depth_camera_info.roi.do_rectify,) = _get_struct_6IB().unpack(str[start:end])
...
class LatestImage(object):
  _type          = 'camera_utils/LatestImage'
  _md5sum = '8b766023585bea29bcbe2ed10ab865f2'
  _request_class  = LatestImageRequest
  _response_class = LatestImageResponse
