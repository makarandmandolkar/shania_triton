...
class UpdatePathActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new UpdatePathFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UpdatePathFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UpdatePathActionFeedback(null);
    ...
    data.feedback = UpdatePathFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += UpdatePathFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdatePathActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = UpdatePathFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new UpdatePathFeedback()
    }
...
module.exports = UpdatePathActionFeedback;
