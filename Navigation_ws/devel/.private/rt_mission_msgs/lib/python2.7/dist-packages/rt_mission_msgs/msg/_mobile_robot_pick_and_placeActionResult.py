...
"""autogenerated by genpy from rt_mission_msgs/mobile_robot_pick_and_placeActionResult.msg. Do not edit."""
import codecs
import sys
...
class mobile_robot_pick_and_placeActionResult(genpy.Message):
  _md5sum = "7152cbfbaa74b1afe9ad7b5e48c1365b"
  _type = "rt_mission_msgs/mobile_robot_pick_and_placeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rt_mission_msgs/mobile_robot_pick_and_placeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mobile_robot_pick_and_placeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rt_mission_msgs.msg.mobile_robot_pick_and_placeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rt_mission_msgs.msg.mobile_robot_pick_and_placeResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3fi().pack(_x.result.success_Result, _x.result.mission_complete_time, _x.result.mission_distance, _x.result.exceeded_distance, _x.result.error_enum))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success_Result, _x.result.mission_complete_time, _x.result.mission_distance, _x.result.exceeded_distance, _x.result.error_enum,) = _get_struct_B3fi().unpack(str[start:end])
