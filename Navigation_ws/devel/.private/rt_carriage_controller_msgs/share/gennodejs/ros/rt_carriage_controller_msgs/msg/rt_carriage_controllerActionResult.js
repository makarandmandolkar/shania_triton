...
class rt_carriage_controllerActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new rt_carriage_controllerResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = rt_carriage_controllerResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new rt_carriage_controllerActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = rt_carriage_controllerResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new rt_carriage_controllerActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = rt_carriage_controllerResult.Resolve(msg.result)
    }
    else {
      resolved.result = new rt_carriage_controllerResult()
    }
...
module.exports = rt_carriage_controllerActionResult;
