...
"""autogenerated by genpy from rt_carriage_controller_msgs/rt_carriage_controllerActionResult.msg. Do not edit."""
import codecs
import sys
...
class rt_carriage_controllerActionResult(genpy.Message):
  _md5sum = "f812e5170e8fd6193b71e14c1c433446"
  _type = "rt_carriage_controller_msgs/rt_carriage_controllerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rt_carriage_controller_msgs/rt_carriage_controllerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rt_carriage_controllerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rt_carriage_controller_msgs.msg.rt_carriage_controllerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rt_carriage_controller_msgs.msg.rt_carriage_controllerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_Bi3d().pack(_x.result.success_Result, _x.result.error_enum, _x.result.exceeded_distance, _x.result.allowable_distance, _x.result.final_position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success_Result, _x.result.error_enum, _x.result.exceeded_distance, _x.result.allowable_distance, _x.result.final_position,) = _get_struct_Bi3d().unpack(str[start:end])
      self.result.success_Result = bool(self.result.success_Result)
      return self
