...
"""autogenerated by genpy from fuse_navigation_msgs/ExecuteTaskAction.msg. Do not edit."""
import codecs
import sys
...
class ExecuteTaskAction(genpy.Message):
  _md5sum = "63475ef0fa14f093a28888aba2b872fc"
  _type = "fuse_navigation_msgs/ExecuteTaskAction"
...
"""
  ...
  _slot_types = ['fuse_navigation_msgs/ExecuteTaskActionGoal','fuse_navigation_msgs/ExecuteTaskActionResult','fuse_navigation_msgs/ExecuteTaskActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteTaskAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = fuse_navigation_msgs.msg.ExecuteTaskActionGoal()
      if self.action_result is None:
        self.action_result = fuse_navigation_msgs.msg.ExecuteTaskActionResult()
      if self.action_feedback is None:
        self.action_feedback = fuse_navigation_msgs.msg.ExecuteTaskActionFeedback()
    else:
      self.action_goal = fuse_navigation_msgs.msg.ExecuteTaskActionGoal()
      self.action_result = fuse_navigation_msgs.msg.ExecuteTaskActionResult()
      self.action_feedback = fuse_navigation_msgs.msg.ExecuteTaskActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.task_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.agent_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.action_plan)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.action_plan:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.task_state
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.action_index
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.task_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.task_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.agent_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.agent_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.action_plan = []
      for i in range(0, length):
        ...
        self.action_goal.goal.action_plan.append(val1)
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.task_state = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.task_state = str[start:end]
      start = end
      end += 4
      (self.action_feedback.feedback.action_index,) = _get_struct_i().unpack(str[start:end])
      return self
