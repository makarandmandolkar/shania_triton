...
"""autogenerated by genpy from fuse_navigation_msgs/ExecutePathActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecutePathActionResult(genpy.Message):
  _md5sum = "3b20a01d76fb3f9c18214c64fd5bf0b0"
  _type = "fuse_navigation_msgs/ExecutePathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fuse_navigation_msgs/ExecutePathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecutePathActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fuse_navigation_msgs.msg.ExecutePathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fuse_navigation_msgs.msg.ExecutePathResult()
