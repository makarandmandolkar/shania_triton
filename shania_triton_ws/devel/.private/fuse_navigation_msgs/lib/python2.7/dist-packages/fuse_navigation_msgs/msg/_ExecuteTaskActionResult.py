...
"""autogenerated by genpy from fuse_navigation_msgs/ExecuteTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecuteTaskActionResult(genpy.Message):
  _md5sum = "3b20a01d76fb3f9c18214c64fd5bf0b0"
  _type = "fuse_navigation_msgs/ExecuteTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fuse_navigation_msgs/ExecuteTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fuse_navigation_msgs.msg.ExecuteTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fuse_navigation_msgs.msg.ExecuteTaskResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.finished_mission
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.finished_mission,) = _get_struct_B().unpack(str[start:end])
      self.result.finished_mission = bool(self.result.finished_mission)
      return self
