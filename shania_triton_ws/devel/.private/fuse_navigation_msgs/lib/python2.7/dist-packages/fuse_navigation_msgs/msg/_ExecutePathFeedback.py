...
"""autogenerated by genpy from fuse_navigation_msgs/ExecutePathFeedback.msg. Do not edit."""
import codecs
import sys
...
class ExecutePathFeedback(genpy.Message):
  _md5sum = "9a7ee1c7269b2a6d4a5cae7a717b3329"
  _type = "fuse_navigation_msgs/ExecutePathFeedback"
...
"""
  __slots__ = ['status','completed_nodes','remaining_nodes','percent_complete','distance_to_end','distance_to_next_node']
  _slot_types = ['string','string[]','string[]','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       status,completed_nodes,remaining_nodes,percent_complete,distance_to_end,distance_to_next_node
    ...
    """
    if args or kwds:
      super(ExecutePathFeedback, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.status is None:
        self.status = ''
      if self.completed_nodes is None:
        self.completed_nodes = []
      if self.remaining_nodes is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.remaining_nodes)
      buff.write(_struct_I.pack(length))
      for val1 in self.remaining_nodes:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.remaining_nodes.append(val1)
      _x = self
      start = end
      end += 24
