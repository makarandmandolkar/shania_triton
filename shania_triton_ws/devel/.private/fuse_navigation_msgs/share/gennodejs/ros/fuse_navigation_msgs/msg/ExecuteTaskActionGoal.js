...
let ExecuteTaskGoal = require('./ExecuteTaskGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ExecuteTaskActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteTaskGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExecuteTaskGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteTaskActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ExecuteTaskGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ExecuteTaskGoal()
    }
...
module.exports = ExecuteTaskActionGoal;
