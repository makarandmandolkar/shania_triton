...
"""autogenerated by genpy from accerion_driver_msgs/GetRecordingsActionResult.msg. Do not edit."""
import codecs
import sys
...
class GetRecordingsActionResult(genpy.Message):
  _md5sum = "1f38687fd1e074100fc114e1b53f63ab"
  _type = "accerion_driver_msgs/GetRecordingsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','accerion_driver_msgs/GetRecordingsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRecordingsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = accerion_driver_msgs.msg.GetRecordingsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = accerion_driver_msgs.msg.GetRecordingsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.recordings)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.recordings:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.recordings.append(val1)
      _x = self
      start = end
      end += 2
