...
"""autogenerated by genpy from accerion_driver_msgs/SendMapAction.msg. Do not edit."""
import codecs
import sys
...
class SendMapAction(genpy.Message):
  _md5sum = "39dd6a0e691ae162f928d40fa4803e4b"
  _type = "accerion_driver_msgs/SendMapAction"
...
"""
  ...
  _slot_types = ['accerion_driver_msgs/SendMapActionGoal','accerion_driver_msgs/SendMapActionResult','accerion_driver_msgs/SendMapActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SendMapAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = accerion_driver_msgs.msg.SendMapActionGoal()
      if self.action_result is None:
        self.action_result = accerion_driver_msgs.msg.SendMapActionResult()
      if self.action_feedback is None:
        self.action_feedback = accerion_driver_msgs.msg.SendMapActionFeedback()
    else:
      self.action_goal = accerion_driver_msgs.msg.SendMapActionGoal()
      self.action_result = accerion_driver_msgs.msg.SendMapActionResult()
      self.action_feedback = accerion_driver_msgs.msg.SendMapActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.placement_mode, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.placement_mode, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
