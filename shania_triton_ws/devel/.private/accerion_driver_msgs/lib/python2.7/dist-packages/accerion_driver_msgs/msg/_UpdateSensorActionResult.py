...
"""autogenerated by genpy from accerion_driver_msgs/UpdateSensorActionResult.msg. Do not edit."""
import codecs
import sys
...
class UpdateSensorActionResult(genpy.Message):
  _md5sum = "0a0c7084bcfe5d45e87f46bd0fb5dafb"
  _type = "accerion_driver_msgs/UpdateSensorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','accerion_driver_msgs/UpdateSensorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UpdateSensorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = accerion_driver_msgs.msg.UpdateSensorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = accerion_driver_msgs.msg.UpdateSensorResult()
