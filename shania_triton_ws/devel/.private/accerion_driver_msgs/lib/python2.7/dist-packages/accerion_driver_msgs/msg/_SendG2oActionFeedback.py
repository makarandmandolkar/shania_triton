...
"""autogenerated by genpy from accerion_driver_msgs/SendG2oActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SendG2oActionFeedback(genpy.Message):
  _md5sum = "45a15c646bc3b0fe4cf85bd83db59cf7"
  _type = "accerion_driver_msgs/SendG2oActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','accerion_driver_msgs/SendG2oFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SendG2oActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = accerion_driver_msgs.msg.SendG2oFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = accerion_driver_msgs.msg.SendG2oFeedback()
