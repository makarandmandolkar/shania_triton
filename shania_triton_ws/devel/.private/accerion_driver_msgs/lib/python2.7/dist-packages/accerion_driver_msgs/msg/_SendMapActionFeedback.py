...
"""autogenerated by genpy from accerion_driver_msgs/SendMapActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SendMapActionFeedback(genpy.Message):
  _md5sum = "45a15c646bc3b0fe4cf85bd83db59cf7"
  _type = "accerion_driver_msgs/SendMapActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','accerion_driver_msgs/SendMapFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SendMapActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = accerion_driver_msgs.msg.SendMapFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = accerion_driver_msgs.msg.SendMapFeedback()
