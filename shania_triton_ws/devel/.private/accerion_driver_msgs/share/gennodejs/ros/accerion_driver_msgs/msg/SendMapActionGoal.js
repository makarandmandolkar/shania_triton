...
class SendMapActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SendMapGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SendMapGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendMapActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SendMapGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SendMapGoal()
    }
...
module.exports = SendMapActionGoal;
