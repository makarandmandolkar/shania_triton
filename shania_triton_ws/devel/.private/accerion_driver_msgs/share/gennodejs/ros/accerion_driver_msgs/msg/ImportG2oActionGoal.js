...
class ImportG2oActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ImportG2oGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ImportG2oActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ImportG2oGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ImportG2oGoal()
    }
...
module.exports = ImportG2oActionGoal;
