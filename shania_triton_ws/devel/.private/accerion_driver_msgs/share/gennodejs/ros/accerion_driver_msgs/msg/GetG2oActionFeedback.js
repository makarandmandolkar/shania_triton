...
class GetG2oActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GetG2oFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetG2oFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetG2oActionFeedback(null);
    ...
    data.feedback = GetG2oFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetG2oActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GetG2oFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GetG2oFeedback()
    }
...
module.exports = GetG2oActionFeedback;
