...
class ImportG2oActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ImportG2oResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ImportG2oResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ImportG2oResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ImportG2oActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ImportG2oResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ImportG2oResult()
    }
...
module.exports = ImportG2oActionResult;
