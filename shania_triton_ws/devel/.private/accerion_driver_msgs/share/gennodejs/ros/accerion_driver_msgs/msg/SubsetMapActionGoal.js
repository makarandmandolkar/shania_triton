...
class SubsetMapActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SubsetMapGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SubsetMapGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SubsetMapActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SubsetMapGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SubsetMapGoal()
    }
...
module.exports = SubsetMapActionGoal;
