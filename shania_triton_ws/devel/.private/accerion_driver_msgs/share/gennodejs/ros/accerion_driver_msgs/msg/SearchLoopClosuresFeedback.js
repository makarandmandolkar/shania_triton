...
class SearchLoopClosuresFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SearchLoopClosuresFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SearchLoopClosuresFeedback(null);
...
module.exports = SearchLoopClosuresFeedback;
