...
class SearchLoopClosuresResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SearchLoopClosuresResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SearchLoopClosuresResult(null);
...
module.exports = SearchLoopClosuresResult;
