...
class SendMapActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SendMapFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SendMapFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SendMapActionFeedback(null);
    ...
    data.feedback = SendMapFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendMapActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SendMapFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SendMapFeedback()
    }
...
module.exports = SendMapActionFeedback;
