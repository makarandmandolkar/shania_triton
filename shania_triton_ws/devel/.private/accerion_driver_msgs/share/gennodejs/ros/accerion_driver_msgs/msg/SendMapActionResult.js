...
class SendMapActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SendMapResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SendMapResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendMapActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SendMapResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SendMapResult()
    }
...
module.exports = SendMapActionResult;
