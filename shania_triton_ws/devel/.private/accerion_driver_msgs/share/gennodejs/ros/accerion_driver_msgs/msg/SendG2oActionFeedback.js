...
class SendG2oActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SendG2oFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SendG2oFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SendG2oActionFeedback(null);
    ...
    data.feedback = SendG2oFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendG2oActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SendG2oFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SendG2oFeedback()
    }
...
module.exports = SendG2oActionFeedback;
