...
class GetG2oActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetG2oResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GetG2oResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetG2oActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GetG2oResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GetG2oResult()
    }
...
module.exports = GetG2oActionResult;
